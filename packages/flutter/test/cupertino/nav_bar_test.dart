...
void main() {
  ...
  testWidgets('CupertinoNavigationBar has correct height', (WidgetTester tester) async {
    ...
    // The box size should match the preferred size.
    expect(navBarBox.size.height, persistentHeight);
  });

  testWidgets('CupertinoNavigationBar with bottom widget has correct preferredSize height', (
    WidgetTester tester,
  ) async {
    const double persistentHeight = 44.0;
  ...
  testWidgets('CupertinoNavigationBar.large has correct preferredSize height', (
    WidgetTester tester,
  ) async {
    const double persistentHeight = 44.0;
  ...
  testWidgets('CupertinoNavigationBar.large with bottom widget has correct preferredSize height', (
    WidgetTester tester,
  ) async {
    const double persistentHeight = 44.0;
    const double largeTitleExtension = 52.0;
